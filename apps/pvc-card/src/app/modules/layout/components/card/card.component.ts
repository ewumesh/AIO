...
export class CardComponent implements OnInit  {
  ...
  url="http://opac.tucl.edu.np:81/api/v1/patrons";
  list:any;
  ...
  header = {
    headers: new HttpHeaders()
      .set('Authorization',  `Basic Basic a29oYS51c2VyOlRlc3RpbmdAMQ==`)
  }

  ngOnInit(): void {
    this.http.get<any[]>(this.url, this.header).subscribe(data => {
      this.list=data;
